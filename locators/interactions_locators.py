...
class SortablePageLocators:
    TAB_LIST = (By.XPATH, '//*[@id="demo-tab-list"]')
    ITEMS_LIST = (
        By.XPATH, '//div[@class="vertical-list-container mt-4"]/div[@class="list-group-item list-group-item-action"]')
    TAB_GRID = (By.XPATH, '//*[@id="demo-tab-grid"]')
    ITEMS_GRID = (By.XPATH, '//div[@class="create-grid"]/div[@class="list-group-item list-group-item-action"]')
